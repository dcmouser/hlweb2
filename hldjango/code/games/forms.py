...
class GameFormForEdit(forms.ModelForm):
    class Meta:
        model = Game
        #fields = ["name", "slug", "subdirname", "preferredFormatPaperSize", "preferredFormatLayout", "isPublic", "text", "gameName", "lastBuildLog", "title", "subtitle", "authors", "version", "versionDate", "summary", "difficulty", "cautions", "duration", "extraInfo", "extraCredits", "url", "textHash", "textHashChangeDate", "publishDate", "leadStats",]
        fields = ["name", "slug", "subdirname", "preferredFormatPaperSize", "preferredFormatLayout", "isPublic", "text", "gameName", "lastBuildLog", "title", "subtitle", "authors", "version", "versionDate", "summary", "difficulty", "cautions", "duration", "extraCredits", "url", "textHash", "textHashChangeDate", "publishDate", "leadStats",]
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        #myReadOnlyFieldList = ["subdirname", "lastBuildLog", "gameName", "title", "subtitle", "authors", "version", "versionDate", "summary", "difficulty", "cautions", "duration", "extraInfo", "extraCredits", "url", "textHash", "textHashChangeDate", "publishDate", "leadStats",  ]
        myReadOnlyFieldList = ["subdirname", "lastBuildLog", "gameName", "title", "subtitle", "authors", "version", "versionDate", "summary", "difficulty", "cautions", "duration", "extraCredits", "url", "textHash", "textHashChangeDate", "publishDate", "leadStats",  ]
